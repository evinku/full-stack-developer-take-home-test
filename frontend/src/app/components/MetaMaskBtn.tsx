  ...
  return (
    <>
      {account ? (
        ...
        <button
          className={`px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white font-bold rounded transition duration-300 flex items-center ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
          disabled={loading}
